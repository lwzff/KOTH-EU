...
------
RegisterNetEvent('kInteractSound_CL:PlayOnOne')
AddEventHandler('kInteractSound_CL:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
RegisterNetEvent('kInteractSound_CL:PlayOnAll')
AddEventHandler('kInteractSound_CL:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
RegisterNetEvent('kInteractSound_CL:PlayWithinDistance')
AddEventHandler('kInteractSound_CL:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
...
------
-- RegisterNetEvent LIFE_CL:Sound:PlayWithinDistanceOS (Bigmode varient of kInteractSound_CL:PlayWithinDistance)
--
...
-- @TODO Change sound volume based on the distance the player is away from the playOnEntity.
------
RegisterNetEvent('kInteractSound_CL:PlayWithinDistanceOS')
AddEventHandler('kInteractSound_CL:PlayWithinDistanceOS', function(playerCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(GetPlayerPed(-1))
